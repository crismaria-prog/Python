...
JORNADA_PADRAO = timedelta(hours=8, minutes=0)

CREDENCIAIS = {
    "cris.maria": {"nome": "cris.maria", "senha": "1234"},
    "ivan.rone": {"nome": "ivan.rone", "senha": "1234"},
    "dina.silva": {"nome": "dina.silva", "senha": "1234"},
    "james.wilson": {"nome": "james.wilson", "senha": "1234"},
}
usuario = ["", "", "", "", "", ""]
