...
ARQUIVO_CSV = "cadastro_de_matriculas.csv" 
CAMPOS =  ["matricula","nome","data","entrada","saida_almoco", "retorno_almoco", "saida"]
JORNADA_PADRAO = timedelta(hours=8 )

CREDENCIAIS = {
    "cris.maria": {"nome": "cris.maria", "senha": "1234"},
    "dina.antony": {"nome": "dina.antony", "senha": "1234"},
    "francisco.cruz": {"nome": "francisco.cruz", "senha": "1234"},
    "any.dibarro": {"nome": "any.dibarro", "senha": "1234"},
}
usuario = ["", "", "", "", "", ""]
